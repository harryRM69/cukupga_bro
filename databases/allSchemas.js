...
export const TodoSchema = {
    ...
    properties: {
        id: 'int',    // primary key
        selectedBtnType: { type: 'string', indexed: true },
        selectedBtnTypeDebit: { type: 'string', indexed: true },
...
export const TodoListSchema = {
    ...
    properties: {
        id: 'int',    // primary key
        selectedBtnType: 'string', // Schema Credit
        selectedMonth2:'int',
        creationDate: 'date',
        selectBtnLabelTetap:'string',
        selectBtnLabelLainnya:'string',
        amount:'string',
        selectedBtnTypeDebit: 'string', // schema Debit
        selectedMonth2Debit:'int',
